...
;(function(factory) {
	...
	else if (typeof define === "function")  // AMD/CMD/Sea.js
	{
        ...
        {
		    define(["examples/js/jquery.min"], factory);  // for Sea.js
        }
	} 
	else
	{ 
    ...
    var $ = window.$; //(typeof (jQuery) !== "undefined") ? jQuery : Zepto;
    ...
    editormd.defaults     = {
        ...
        watch                : false,
        placeholder          : "TstoryHelper는 MarkDown을 지원합니다...",
        gotoLine             : true,
        codeFold             : false,
        autoHeight           : false,
		autoFocus            : false,
